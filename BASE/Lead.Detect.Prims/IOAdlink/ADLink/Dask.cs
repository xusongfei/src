...
namespace Lead.Detect.PrimIOAdlink.ADLink
{
...
/*---------------------------------------------------------------------------*/
        ...
        [DllImport("PCI-Dask.dll")]
        public static extern short AI_ContReadMultiChannelsToFile(ushort CardNumber, ushort NumChans, ushort[] Chans, ushort[] AdRanges, string[] FileName, uint ReadCount, double SampleRate,
            ushort SyncMode);
...
/*---------------------------------------------------------------------------*/
        ...
        [DllImport("PCI-Dask.dll")]
        public static extern short AO_ContWriteMultiChannels(ushort CardNumber, ushort NumChans, ushort[] Chans, ushort BufId, uint WriteCount, uint Iterations, uint CHUI, ushort definite,
            ushort SyncMode);
...
/*---------------------------------------------------------------------------*/
        ...
        [DllImport("PCI-Dask.dll")]
        public static extern short DI_7350_ExportSampCLKConfig(ushort CardNumber, ushort CLK_Src, ushort CLK_DAOIode, ushort CLK_DPAVlaue);

        [DllImport("PCI-Dask.dll")]
        public static extern short DI_7350_ExtSampCLKConfig(ushort CardNumber, ushort CLK_Src, ushort CLK_DDAMode, ushort CLK_DAOIode, ushort CLK_DDAVlaue, ushort CLK_DPAVlaue);

        [DllImport("PCI-Dask.dll")]
        public static extern short DI_7350_SoftTriggerGen(ushort CardNumber);

        [DllImport("PCI-Dask.dll")]
        public static extern short DI_7350_TrigHSConfig(ushort CardNumber, ushort TrigConfig, ushort DI_IPOL, ushort DI_REQSrc, ushort DI_ACKSrc, ushort DI_TRIGSrc, ushort StartTrigSrc,
            ushort PauseTrigSrc, ushort SoftTrigOutSrc, uint SoftTrigOutLength, uint TrigCount);
        ...
        [DllImport("PCI-Dask.dll")]
        public static extern short DI_7360_ExportSampCLKConfig(ushort CardNumber, ushort CLK_Src, ushort CLK_DAOIode, ushort CLK_DPAVlaue);

        [DllImport("PCI-Dask.dll")]
        public static extern short DI_7360_ExtSampCLKConfig(ushort CardNumber, ushort CLK_Src, ushort CLK_DDAMode, ushort CLK_DAOIode, ushort CLK_DDAVlaue, ushort CLK_DPAVlaue);

        [DllImport("PCI-Dask.dll")]
        public static extern short DI_7360_SoftTriggerGen(ushort CardNumber);

        [DllImport("PCI-Dask.dll")]
        public static extern short DI_7360_TrigHSConfig(ushort CardNumber, ushort TrigConfig, ushort DI_IPOL, ushort DI_REQSrc, ushort DI_ACKSrc, ushort DI_TRIGSrc, ushort StartTrigSrc,
            ushort PauseTrigSrc, ushort SoftTrigOutSrc, uint SoftTrigOutLength, uint TrigCount);
...
/*---------------------------------------------------------------------------*/
        ...
        [DllImport("PCI-Dask.dll")]
        public static extern short DO_7350_ExportSampCLKConfig(ushort CardNumber, ushort CLK_Src, ushort CLK_DAOIode, ushort CLK_DPAVlaue);

        [DllImport("PCI-Dask.dll")]
        public static extern short DO_7350_ExtSampCLKConfig(ushort CardNumber, ushort CLK_Src, ushort CLK_DDAMode, ushort CLK_DAOIode, ushort CLK_DDAVlaue, ushort CLK_DPAVlaue);

        [DllImport("PCI-Dask.dll")]
        public static extern short DO_7350_SoftTriggerGen(ushort CardNumber);

        [DllImport("PCI-Dask.dll")]
        public static extern short DO_7350_TrigHSConfig(ushort CardNumber, ushort TrigConfig, ushort DO_IPOL, ushort DO_REQSrc, ushort DO_ACKSrc, ushort DO_TRIGSrc, ushort StartTrigSrc,
            ushort PauseTrigSrc, ushort SoftTrigOutSrc, uint SoftTrigOutLength, uint TrigCount);
        ...
        [DllImport("PCI-Dask.dll")]
        public static extern short DO_7360_ExportSampCLKConfig(ushort CardNumber, ushort CLK_Src, ushort CLK_DAOIode, ushort CLK_DPAVlaue);

        [DllImport("PCI-Dask.dll")]
        public static extern short DO_7360_ExtSampCLKConfig(ushort CardNumber, ushort CLK_Src, ushort CLK_DDAMode, ushort CLK_DAOIode, ushort CLK_DDAVlaue, ushort CLK_DPAVlaue);

        [DllImport("PCI-Dask.dll")]
        public static extern short DO_7360_SoftTriggerGen(ushort CardNumber);

        [DllImport("PCI-Dask.dll")]
        public static extern short DO_7360_TrigHSConfig(ushort CardNumber, ushort TrigConfig, ushort DO_IPOL, ushort DO_REQSrc, ushort DO_ACKSrc, ushort DO_TRIGSrc, ushort StartTrigSrc,
            ushort PauseTrigSrc, ushort SoftTrigOutSrc, uint SoftTrigOutLength, uint TrigCount);
...
/*---------------------------------------------------------------------------*/
        ...
        [DllImport("PCI-Dask.dll")]
        public static extern short PCI9524_Acquire_AD_CalConst(ushort CardNumber, ushort Group, ushort ADC_Range, ushort ADC_Speed, out uint CalDate, out float CalTemp, out uint ADC_offset,
            out uint ADC_gain, out double Residual_offset, out double Residual_scaling);

        [DllImport("PCI-Dask.dll")]
        public static extern short PCI9524_Acquire_DA_CalConst(ushort CardNumber, ushort Channel, out uint CalDate, out float CalTemp, out byte DAC_offset, out byte DAC_linearity,
            out float Gain_factor);
...
/*----------------------------------------------------------------------------*/
        ...
        [DllImport("PCI-Dask.dll")]
        public static extern short SPI_Read(ushort CardNumber, ushort SPI_Port, ushort SPI_SlaveAddr, ushort SPI_CmdAddrBits, ushort SPI_DataBits, ushort SPI_FrontDummyBits, uint SPI_CmdAddr,
            out uint SPI_Data);
...
/*----------------------------------------------------------------------------*/
        ...
        [DllImport("PCI-Dask.dll")]
        public static extern short SPI_Write(ushort CardNumber, ushort SPI_Port, ushort SPI_SlaveAddr, ushort SPI_CmdAddrBits, ushort SPI_DataBits, ushort SPI_FrontDummyBits, ushort SPI_TailDummyBits,
            uint SPI_CmdAddr, uint SPI_Data);
