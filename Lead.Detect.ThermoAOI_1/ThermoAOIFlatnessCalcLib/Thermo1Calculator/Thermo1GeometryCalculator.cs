...
{
    [XmlInclude(typeof(A117FullModuleCalculator))]
    [XmlInclude(typeof(A117VcCalculator))]
    [XmlInclude(typeof(A147FullModuleCalculator))]
    [XmlInclude(typeof(A147VcCalculator))]
    [XmlInclude(typeof(X1311Calculator))]
    [TypeConverter(typeof(ExpandableObjectConverter))]
    public class Thermo1GeometryCalculator : UserSettings<Thermo1GeometryCalculator>
    {
        public Thermo1GeometryCalculator()
        {
        }
        ...
        public static void Import(string desc)
        {
            ...
            var g = new Thermo1GeometryCalculator();
